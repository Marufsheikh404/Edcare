...
import image from '../../images/home page/blog6.png'
        ...
        <section className="lg:py-10" >
            <div className='flex flex-col lg:flex-row gap-3 p-10 rounded-md' style={{ backgroundImage: `url(${bg.src})` }}>
                ...
                <div>
                    ...
                    <h1 data-aos="fade-up" data-aos-duration="2000" className='text-4xl text-white font-bold my-3'>Find Your Best Course With Us</h1>
                    <div data-aos="fade-up" data-aos-duration="2000"> <SectionTitle des={'Quality technologies via fully tested methods of empowerment. Proactively disseminate web enabled best practices after cross functional expertise.'}></SectionTitle></div>
                    <div data-aos="fade-up" data-aos-duration="2000" className='flex items-center gap-5 my-2'>
                    ...
                    <button data-aos="fade-up" data-aos-duration="2000" className="hidden sm:inline-flex items-center py-2 px-4 rounded-full text-sm  font-semibold text-white bg-[#39B8AD] hover:bg-[#2fa79b] transition-shadow shadow-sm my-2">SubCribe Now</button>
                </div>
            </div>
        </section>
    );
