    ...
    return (
        <section className="w-full bg-white py-20 px-4 md:px-10">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div data-aos="fade-up-right" data-aos-duration="2000" className="md:col-span-3 flex flex-col items-center md:items-start md:-translate-y-13">
                    <div className="border border-gray-300 p-2 rounded-tr-4xl rounded-bl-4xl w-full md:max-w-[250px]">
                        <Image
                            className="rounded-tr-4xl rounded-bl-4xl h-80 w-full"
                            src={image}
                            alt="image"
                        />
                    </div>
                    <div className="bg-[#07A698] mt-3 flex items-center rounded-tr-4xl rounded-bl-4xl p-2 w-full h-25 max-w-[250px]">
                ...
                <div data-aos="fade-up-right" data-aos-duration="2000" className="md:col-span-3 flex justify-center md:justify-start mt-10 md:mt-0">
                    <Image
                        className="rounded-tl-4xl rounded-br-4xl w-full h-96"
                        src={image2}
                        alt="image2"
                    />
                </div>
