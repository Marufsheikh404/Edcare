            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-12 gap-6 items-start">
                    ...
                    <div className="col-span-12 md:col-span-7 flex flex-col gap-6">
                        <div className="inline-flex items-center gap-3 bg-white rounded-full px-3 py-2 shadow-sm w-fit">
                        ...
                        <SectionTitle title="Powerful Dashboard And High Performance Framework" />
